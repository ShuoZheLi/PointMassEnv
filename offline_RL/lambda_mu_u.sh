...
conda_env="corl_0"
project="mu_loss_study_normal_a_weight_load_lambda_mu_u_dsa"
checkpoints_path_base="mu_loss_study_normal_a_weight_load_lambda_mu_u_dsa"
...
# semi_dice_lambda_values=(0.4 0.45 0.5 0.55 0.6)
...
# mu_lambda_values=(0.3 0.4 0.5 0.6 0.7 0.8 0.9 1.0)
mu_lambda_values=(0.5 0.6 0.7 0.8)
# mu_lambda_values=(0.85)
          ...
          for semi_dice_lambda in "${semi_dice_lambda_values[@]}"; do
            for semi_q_alpha in "${semi_q_alpha_values[@]}"; do
              for current_seed in "${seed[@]}"; do
                for mu_lambda in "${mu_lambda_values[@]}"; do
                  ...
                  # append mu_lambda
                  session_name="${session_name}_mu_lambda_${mu_lambda}"
                  ...
                  tmux send-keys -t $session_name "CUDA_VISIBLE_DEVICES=$device \
                                                  python3 offline_RL/lambda_mu_u.py \
                                                  --env_name $env_name \
