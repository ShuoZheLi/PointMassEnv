...
conda_env="corl_0"
project="pi_qdice_old_frenchel_dual_bc_pi"
checkpoints_path_base="pi_qdice_old_frenchel_dual_bc_pi"
...
# semi_q_alpha_values=(0.5 1.0 1.5 2.0)
semi_q_alpha_values=(3.0 4.0 5.0 6.0)
        ...
        for semi_q_alpha in "${semi_q_alpha_values[@]}"; do
          for current_seed in "${seed[@]}"; do
            ...
            tmux send-keys -t $session_name "CUDA_VISIBLE_DEVICES=$device \
                                            python3 offline_RL/vdice_correct_filter_q_eval.py \
                                            --env_name $env_name \
                                            ...
                                            --project $project \
                                            --load_model pi_qdice_alpha/0_5/model/checkpoint_299999.pt \
                                            --load_yaml pi_qdice_alpha/0_5/config.yaml \
