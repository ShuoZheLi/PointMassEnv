...
class TrainConfig:
    ...
    checkpoints_path: Optional[str] = "suboptimal_iql_beta_6"  # Save path
    ...
    # Wandb logging
    project: str = "toy_case_suboptimal_iql_beta_6"
    group: str = "IQL-D4RL"
    name: str = "IQL"
...
def train(config: TrainConfig):
    ...
    os.makedirs(config.checkpoints_path+"/gif", exist_ok=True)
    ...
    for t in range(int(config.max_timesteps)):
        ...
        if (t + 1) % config.eval_freq == 0:
            ...
            eval_policy(actor, t, config.checkpoints_path+"/gif", config.device, wandb, "iql")
